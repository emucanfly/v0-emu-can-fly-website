        ...
        <div className="relative bg-gradient-to-br from-primary/10 via-accent/5 to-background py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-balance">United Kingdom Travel Deals</h1>
              <p className="text-lg md:text-xl text-muted-foreground text-balance max-w-2xl mx-auto">
                Search and compare flights and hotels in GBP
              </p>
            </div>
            ...
            <Card className="max-w-5xl mx-auto p-6 md:p-8 shadow-xl">
              <Tabs defaultValue="flights" className="w-full">
                ...
                <TabsContent value="flights" className="mt-0">
                  <FlightSearch defaultCurrency="GBP" />
                </TabsContent>
